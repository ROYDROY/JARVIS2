        ...
        try:
            ...
            if modelo_chat_local in modelo_elegido.lower() and "ollama" in modelo_elegido.lower() and self.combo_modo.get() != "Ingeniero":
                ...
                try:
                    ...
                    msgs_ft = [{"role": "system", "content": f"Eres JARVIS, el asistente personal de Rubén. Responde SIEMPRE en español, de forma directa, natural y amigable. Nunca pongas excusas. Sigue siempre la corriente de la conversación. {_ctx_tiempo}"}]
