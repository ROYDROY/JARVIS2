...
- **Escanear Documentos:** Si el usuario te pide escanear un documento en general, usa el script: `C:\JARVIS2\herramientas\Escanear-Documento.ps1`.
  Si te pide específicamente escanear **usando Adobe Acrobat** (o "el programa que abriste"), ejecuta la automatización de interfaz con: `python C:\JARVIS2\herramientas\Escanear-Acrobat.py`. Este script buscará la ventana de Acrobat Pro, la traerá al frente y enviará los atajos de teclado para activar el menú de escaneo. En PowerShell o Python, ejecuta la herramienta en un paso y luego muestra el resultado final.
